...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:31983',
            //extent: [292068.099767, 7205489.858876, 474521.646765, 7404546.129346],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([358287.181695, 7345859.549089, 375327.023050, 7355533.930564], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Zoneamento do PDZ do Porto de Santos</h2>';
        return titleElement;
    })(),
